        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" class="header">
                    <!--begin::Header top-->
                    <div class="header-top d-flex align-items-stretch flex-grow-1 h-60px h-lg-80px" data-kt-sticky="true" data-kt-sticky-name="header-topbar" data-kt-sticky-offset="{default: '100px', lg: 'false'}" data-kt-sticky-dependencies="#kt_wrapper" data-kt-sticky-class="fixed-top bg-body shadow-sm border-0">
                        ...
                        <div class="d-flex w-100 p-5">
                            ...
                            <div class="d-flex flex-stack align-items-stretch w-100">
                                ...
                                <div class="d-flex align-items-center align-items-lg-stretch me-5">
                                    ...
                                    <!--begin::Logo-->
                                    <a href="../../demo21/dist/index.html" class="d-flex align-items-center">
                                        <img alt="Logo" src="assets/media/logos/demo21.svg" class="h-25px h-lg-30px" />
                                    </a>
                                    <!--end::Logo-->
                                </div>
                                <!--end::Brand-->
                    ...
                    <!--end::Header top-->
                    <!--begin::Header bottom-->
                    <?php require 'views/header_tabs.php'; ?>

                    <!--end::Header bottom-->
                </div>
                <!--end::Header-->
                <!--begin::Container-->
                <div id="kt_content_container" class="d-flex flex-column-fluid">
                    <!--begin::Content-->
